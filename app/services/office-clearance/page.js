            ...
            <div className="relative flex justify-center items-center lg:pr-12">
              <FadeUp delay={0.4}>
                ...
                >
                  ...
                  <div className="relative w-56 h-56 md:w-[400px] md:h-[400px] rounded-full border-4 md:border-[16px] border-white/20 shadow-2xl overflow-hidden ring-4 md:ring-8 ring-white/10">
                    <Image 
